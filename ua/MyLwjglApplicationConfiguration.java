...
public class MyLwjglApplicationConfiguration {
	/**
	 ...
	 * 
	 * @see <a href=
	 *      "http://legacy.lwjgl.org/javadoc/org/lwjgl/opengl/ContextAttribs.html">LWJGL
	 *      OSX ContextAttribs note</a>
	 */
	 ...
	 */
	public MyLwjglGraphics.SetDisplayModeCallback setDisplayModeCallback;
	...
	public static DisplayMode[] getDisplayModes() {
		...
		for (java.awt.DisplayMode mode : displayModes) {
			...
			if (mode.getBitDepth() != desktopMode.getBitDepth())
				continue;
			modes.add(new LwjglApplicationConfigurationDisplayMode(mode.getWidth(), mode.getHeight(),
