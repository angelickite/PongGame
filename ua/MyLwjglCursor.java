...
public class MyLwjglCursor implements Cursor {
	org.lwjgl.input.Cursor lwjglCursor = null;

	public MyLwjglCursor (Pixmap pixmap, int xHotspot, int yHotspot) {
		if (((MyLwjglGraphics)Gdx.graphics).canvas != null && SharedLibraryLoader.isMac) {
			return;
		}
		try {
			if (pixmap == null) {
